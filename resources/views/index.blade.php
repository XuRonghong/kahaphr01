            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{url('dodel')}}" method="post">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">

                            <a class="btn btn-default btn-lg btn-block" href="{{url('add')}}">Add</a>
                            ...
                            <tbody>
                            @foreach($sys_member as $item)
                            <tr class="odd gradeX">
                                <td class="center">{{$item->vName}}</td>
                                <td class="center">{{$item->vGender}}</td>
                                <td class="center">{{$item->iBirthday}}</td>
                                <td class="center">{{$item->vEmail}}</td>
                                <td class="center">{{$item->vContact}}</td>
                                <td class="center">{{$item->vAddress}}</td>
                                <td class="center edit" data-id="{{$item->iId}}">修改</td>
                                <td class="center del" data-id="{{$item->iId}}">X</td>
                            </tr>
                            @endforeach
                            </tbody>

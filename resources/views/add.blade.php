                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{url('doadd')}}" method="post">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <tr class="odd gradeX">
                                    <td class="center"><input type="text" class="form-control" name="vName"></td>
                                    <td class="center"><input type="text" class="form-control" name="vGender"></td>
                                    <td class="center"><input type="date" class="form-control" name="iBirthday"></td>
                                    <td class="center"><input type="text" class="form-control" name="vEmail"></td>
                                    <td class="center"><input type="text" class="form-control" name="vContact"></td>
                                    <td class="center"><input type="text" class="form-control" name="vAddress"></td>
                                </tr>
                                </tbody>
                            </table>
